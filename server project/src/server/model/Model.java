...
public interface Model {
	 ...
	 */
	void generateMaze3d(String client, String mazeName, int x, int y, int z) throws Exception;
	 ...
	 */
	void solveMaze(String client, String mazeName, String Solver) throws Exception;
	 ...
	 */
	void saveCompressedMaze(String client, String mazeName, String fileName) throws Exception;
	 ...
	 */
	void loadDecompressedMaze(String client, String fileName, String mazeName) throws Exception;
	 ...
	 * 
	 * @param f [IN] The directory. {@link File}
	 * 
	 * @return The files and directories. {@link File[]}
	 */
