		...
		for (int i = 0; i < this.getMaze().length; i++) {
			for (int j = 0; j < this.getMaze()[i].length; j++) {
				for (int k = 0; k < this.getMaze()[i][j].length; k++) {
					System.out.print(this.getMaze()[i][j][k] + "\t");
				}
				System.out.println("");
			}
			System.out.println("Floor #" + i);
		}
		//System.out.println("Entrance: " + this.getEntrance().getX() + ", " + this.getEntrance().getY() + ", " + this.getEntrance().getZ());
		//System.out.println("Exit: " + this.getExit().getX() + ", " + this.getExit().getY() + ", " + this.getExit().getZ());
	}
