...
/**
 * DisplayCrossSectionByZCommand displays the plane of the given maze when the Z dimension is the given index.
 * 
 * @author Aviv Moran & Ayal Naim
 * 
 */
public class DisplayCrossSectionByZCommand implements Command {
	 ...
	 */
	public DisplayCrossSectionByZCommand(Model m, View v) {
		this.m = m;
		this.v = v;
	...
	public void doCommand(String args) throws Exception {
		...
		int[][] plane = m.getCrossSection(parameters[1], "Z",  Integer.parseInt(parameters[0]));
